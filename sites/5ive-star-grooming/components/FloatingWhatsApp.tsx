...
const FloatingWhatsApp = () => {
  ...
  const whatsappNumber = "233506436174";
  const message = "Hello! I'd like to book an appointment at 5IVE STAR GROOMING.";
          ...
          >
            ...
            <div className="bg-gradient-to-r from-gold-dark via-gold to-gold-dark p-4 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h4 className="font-bold text-white">5IVE STAR GROOMING</h4>
            ...
            <div className="p-6">
              <div className="bg-gold/10 rounded-lg p-4 mb-4">
                <p className="text-white text-sm">
                  👋 Hello! Ready for a fresh cut? Message us on WhatsApp to book your 5-star grooming session!
                </p>
              </div>
